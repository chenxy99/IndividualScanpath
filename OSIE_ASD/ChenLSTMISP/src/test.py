...
parser.add_argument("--img_dir", type=str, default="/home/OSIE_autism/stimuli",
                    help="Directory to the image data (stimuli)")
parser.add_argument("--fix_dir", type=str, default="/home/OSIE_autism/processed",
...
parser.add_argument("--action_map_num", type=int, default=6, help="The dim of action map")
