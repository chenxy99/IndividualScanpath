...
def parse_opt():
    ...
    parser.add_argument("--img_dir", type=str, default="/home/OSIE_autism/stimuli", help="Directory to the image data (stimuli)")
    parser.add_argument("--fix_dir", type=str, default="/home/OSIE_autism/processed", help="Directory to the raw fixation file")
    ...
    parser.add_argument("--no_eval_epoch", type=int, default=0, help="The number of no evaluation epoch")
