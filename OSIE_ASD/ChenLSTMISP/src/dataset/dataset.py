...
class OSIE(Dataset):
    ...
    def __init__(self,
        ...
        self.fixations_file = join(self.OSIE_fixations_dir, "fixations.json")
    ...
    def collate_func(self, batch):
        ...
        for sample in batch:
            ...
            tmp_action_mask, tmp_duration_mask, tmp_subject, tmp_img_name =\
...
class OSIE_evaluation(Dataset):
    ...
    def collate_func(self, batch):
        ...
        for sample in batch:
            tmp_img, tmp_fix_vectors, tmp_subject, tmp_img_name = sample["image"], sample["fix_vectors"], sample[
                "subject"], sample["img_name"]
            img_batch.append(tmp_img)
...
class OSIE_rl(Dataset):
    ...
    def collate_func(self, batch):
        ...
        for sample in batch:
            tmp_img, tmp_fix_vectors, tmp_subject, tmp_img_name = sample["image"], sample["fix_vectors"], sample["subject"], sample["img_name"]
            img_batch.append(tmp_img)
            fix_vectors_batch.append(tmp_fix_vectors)
            subject_batch.append(tmp_subject)
            img_name_batch.append(tmp_img_name)
