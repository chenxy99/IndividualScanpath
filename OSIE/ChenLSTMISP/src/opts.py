...
def parse_opt():
    ...
    parser.add_argument("--img_dir", type=str, default="/media/OSIE/stimuli", help="Directory to the image data (stimuli)")
    parser.add_argument("--fix_dir", type=str, default="/media/OSIE/processed", help="Directory to the raw fixation file")
    ...
    parser.add_argument("--gpu_ids", type=list, default=[0, 1, 2], help="Used gpu ids")
