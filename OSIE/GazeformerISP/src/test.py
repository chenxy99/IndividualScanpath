...
parser.add_argument("--img_dir", type=str, default="/srv/OSIE/images", help="Directory to the image data (stimuli)")
parser.add_argument("--feat_dir", type=str, default="/srv/OSIE/image_features",
                    help="Directory to the image feature data (stimuli)")
parser.add_argument("--fix_dir", type=str, default="/srv/OSIE/processed", help="Directory to the raw fixation file")
...
parser.add_argument("--evaluation_dir", type=str, default="../runs/runX",
