...
def parse_opt():
    ...
    parser.add_argument("--img_dir", type=str, default="/home/AiR/stimuli", help="Directory to the image data (stimuli)")
    parser.add_argument("--fix_dir", type=str, default="/home/AiR/processed_data", help="Directory to the raw fixation file")
    parser.add_argument("--att_dir", type=str, default="/home/AiR/attention_reasoning",
                        help="Directory to the attention maps")
    ...
    parser.add_argument("--start_rl_epoch", type=int, default=20, help="Epoch when starting reinforcement learning")
    ...
    parser.add_argument("--lambda_2", type=float, default=1.0, help="Hyper-parameter for subject loss term")
    parser.add_argument("--eval_repeat_num", type=int, default=1, help="Repeat number for evaluation")
    parser.add_argument("--min_length", type=int, default=0, help="Minimum length of the generated scanpath")
    ...
    parser.add_argument("--no_eval_epoch", type=int, default=-1, help="The number of no evaluation epoch")
