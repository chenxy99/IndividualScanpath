...
parser.add_argument("--img_dir", type=str, default="/home/AiR/stimuli",
                    help="Directory to the image data (stimuli)")
parser.add_argument("--fix_dir", type=str, default="/home/AiR/processed_data",
...
parser.add_argument("--evaluation_dir", type=str, default="../runs/AiR_baseline",
...
parser.add_argument("--subject_num", type=int, default=20, help="The number of the subject in AiR")
...
def main():
    ...
    test_dataset = AiR_evaluation(args.img_dir, args.fix_dir, args.att_dir, action_map=(args.map_height, args.map_width),
    ...
    model = baseline(embed_size=512, convLSTM_length=args.max_length, min_length=args.min_length, dropout=args.dropout,
                     subject_num=args.subject_num, embedding_dim=args.embedding_dim).cuda()
