...
parser.add_argument("--img_dir", type=str, default="/srv/data/AiR/stimuli",
...
parser.add_argument("--fix_dir", type=str, default="/srv/data/AiR/processed_data",
...
def main():
    ...
    test_dataset = AiR_evaluation(args.img_dir, args.feat_dir, args.fix_dir, action_map=(args.im_h, args.im_w),
