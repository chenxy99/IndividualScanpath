...
from utils.evaluation import human_evaluation, evaluation, pairs_eval, human_evaluation_by_subject, \
    evaluation_by_subject, comprehensive_evaluation_by_subject
...
def main():
    ...
    train_dataset = AiR(args.img_dir, args.feat_dir, args.fix_dir, action_map=(args.im_h, args.im_w),
    ...
    #                      resize=(args.height, args.width), origin_size=(args.origin_height, args.origin_width),
    #                      blur_sigma=args.blur_sigma, type="train", transform=transform, max_length=args.max_length)
    train_dataset_rl = AiR_rl(args.img_dir, args.feat_dir, args.fix_dir, action_map=(args.im_h, args.im_w),
                                               origin_size = (args.origin_height, args.origin_width),
                                               resize=(args.height, args.width), type="train", transform=transform)
    validation_dataset = AiR_evaluation(args.img_dir, args.feat_dir, args.fix_dir, action_map=(args.im_h, args.im_w),
                                               origin_size = (args.origin_height, args.origin_width),
