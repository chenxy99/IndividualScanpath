...
with open("/home/COCOSearch18/TP/fixations/coco_search18_fixations_TP_test.json") as json_file:
    fixations = json.load(json_file)

with open("../../runs/COCOSearch_baseline_40epoch_rl_decay0.1_20epoch_seed10_full_version/test_predicts.json") as json_file:
    predict_fixations = json.load(json_file)

qualitative_result_dir = "../../runs/COCOSearch_baseline_40epoch_rl_decay0.1_20epoch_seed10_full_version/qualitative_result_test_for_qual"
