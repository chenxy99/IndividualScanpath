...
def main():
    ...
    train_dataset = COCOSearch(args.img_dir, args.feat_dir, args.fix_dir, action_map=(args.im_h, args.im_w),
    ...
    train_dataset_rl = COCOSearch_rl(args.img_dir, args.feat_dir, args.fix_dir, action_map=(args.im_h, args.im_w),
                                               origin_size = (args.origin_height, args.origin_width),
                                               resize=(args.height, args.width), type="train", transform=transform)
    validation_dataset = COCOSearch_evaluation(args.img_dir, args.feat_dir, args.fix_dir, action_map=(args.im_h, args.im_w),
                                               origin_size = (args.origin_height, args.origin_width),
                                               resize=(args.height, args.width), type="valid", transform=transform)
